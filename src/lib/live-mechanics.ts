...
export const LIVE_MECHANICS = ['shake', 'stamp', 'check-in-loyalty', 'spin', 'dice', 'lottery', 'buy-x-get-y', 'coupon', 'flash', 'combo', 'friend', 'groupunlock'] as const satisfies readonly MechanicType[]
