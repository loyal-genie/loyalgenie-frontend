...
describe('upcoming campaign listing helpers', () => {
  ...
  it('formats Live on dd-mm with optional start time', () => {
    expect(formatCampaignLiveOnLabel('2026-07-16', '00:00', '23:59')).toBe('Live on 16-07')
    expect(formatCampaignLiveOnLabel('2026-07-16', '16:00', '21:00')).toBe('Live on 16-07 · 4PM')
  })
})
